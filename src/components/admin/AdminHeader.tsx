              ...
              <div className="flex items-center space-x-4">
                {showBackButton && (
                  <button 
                    ...
                    className="text-gray-500 hover:text-gray-700 p-2 -m-2 rounded-lg hover:bg-gray-100 transition-colors"
                  >
                ...
                <a 
                  href="/admin" 
                  className="text-xl sm:text-2xl font-bold text-gray-900 hover:text-purple-600 transition-colors cursor-pointer"
                >
                  {title}
                </a>
              </div>
